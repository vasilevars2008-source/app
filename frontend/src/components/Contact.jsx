...
export const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="py-24 md:py-32 px-6 md:px-12 lg:px-24 bg-sand-100/40"
    >
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
        <Reveal>
          ...
          <p className="text-base lg:text-lg text-ink/65 leading-relaxed mt-6 max-w-md">
            {t.contact.desc}
          </p>

          <p className="font-serif italic text-2xl text-terracotta mt-10">
            {t.footer.slogan}
          </p>
        </Reveal>
        ...
        <Reveal delay={0.1}>
          <form
            ...
            onSubmit={onSubmit}
            className="bg-white rounded-3xl p-8 md:p-10 border border-sand-100 shadow-sm space-y-5"
          >
            <div>
