...
export const translations = {
  ...
  pl: {
    nav: { about: "O nauczycielce", why: "Dlaczego ArtJoga", state: "Stan", formats: "Formaty", atmosphere: "Atmosfera", reviews: "Opinie", faq: "Pytania", contacts: "Kontakt", book: "Zapisz się" },
    hero: {
      tag: "Kundalini Yoga Studio",
      title: "Kundalini Yoga for Body, Mind & Soul",
      slogan: "Find Harmony. Feel Love. Live Consciously.",
      desc: [
        "ArtJoga to przestrzeń ciszy pośród zgiełku codziennego życia.",
        "Tutaj, poprzez jogę kundalini, świadomy oddech i medytację, wracasz do siebie: uwalniasz napięcie, odzyskujesz siły, budzisz wewnętrzną energię i uczysz się żyć w harmonii z ciałem, umysłem i duszą.",
        "Joga kundalini to joga neutralnego umysłu. Przestajesz być ślepo pochłonięty emocjami, przekonaniami i reakcjami, a zyskujesz dostęp do punktu wewnętrznej obserwacji, z którego wszystko widać jasno, jak na dłoni.",
        "Każda praktyka to krok ku spokojowi, jasności i miłości do siebie. Bo prawdziwe zmiany zaczynają się wewnątrz.",
      ],
      book: "Zapisz się",
    ...
    about: {
      tag: "O nauczycielce",
      name: "Aleksandra Vasileuskaya",
      role: "Nauczycielka Kundalini Yogi",
      desc: "Nazywam się Aleksandra. Jestem nauczycielką jogi kundalini. Moim celem jest pomóc ludziom odnaleźć wewnętrzną harmonię, poprawić jakość życia i odkryć swój potencjał poprzez praktykę jogi, oddechu i medytacji. W swojej pracy łączę techniki oddechowe, krije, medytacje i głęboką relaksację. Praktyki pomagają zmniejszyć stres, podnieść poziom energii, poprawić koncentrację i poczuć więcej pewności w codziennym życiu. Najważniejsze w życiu są dla mnie miłość, świadomość i troska o siebie.",
      stat1: { num: "2000+", label: "Zajęć" },
      stat2: { num: "8+", label: "Lat praktyki" },
    },
    why: {
      tag: "Dlaczego ArtJoga",
      title: "Więcej niż zajęcia jogi",
      lead: "ArtJoga to więcej niż zajęcia jogi. Nazwa łączy dwa ważne znaczenia.",
      art: { letter: "Art", desc: "Sztuka świadomego życia, odczuwania piękna chwili i tworzenia swojego życia z miłością." },
      joga: { letter: "Joga", desc: "Droga łączenia ciała, umysłu i duszy poprzez praktykę." },
      paras: [
        "Każde zajęcia ArtJoga to możliwość zatrzymania się w szybkim rytmie życia, uwolnienia napięcia, przywrócenia wewnętrznej równowagi i naładowania energią.",
        "Nie ma tu rywalizacji, porównywania ani dążenia do perfekcji. Jest tylko szacunek do własnego ciała, swojego stanu i swojego tempa.",
        "ArtJoga to przestrzeń, w której praktyka staje się częścią życia, a wewnętrzne zmiany stopniowo ujawniają się w świecie zewnętrznym.",
      ],
    },
    state: {
      tag: "Stan",
      title: "Twój stan",
      intro: [
        "Praktyka zaczyna się na macie, a trwa dalej w codziennym życiu.",
        "Joga kundalini to droga do wewnętrznej równowagi, jasności i harmonii. Z każdą praktyką uczysz się lepiej słyszeć siebie, odzyskiwać siły i tworzyć przestrzeń, w której łatwiej żyć, czuć i podejmować decyzje.",
      ],
      items: [
        { title: "Wewnętrzny spokój", desc: "Zyskaj stabilność i zachowaj równowagę nawet w najbardziej intensywnym rytmie życia." },
        { title: "Energia życiowa", desc: "Naładuj się siłą, by żyć aktywnie, tworzyć i inspirować się każdego dnia." },
        { title: "Jasność umysłu", desc: "Uwolnij się od wewnętrznego szumu, by podejmować decyzje spokojnie i świadomie." },
        { title: "Głęboki sen", desc: "Relaksacja układu nerwowego pomaga ciału w pełni się zregenerować i budzić się wypoczętym." },
        { title: "Zdrowe ciało", desc: "Rozwijaj elastyczność, siłę, swobodny oddech i poczucie lekkości w każdym ruchu." },
        { title: "Koncentracja", desc: "Rozwijaj zdolność bycia w chwili obecnej i utrzymywania uwagi na tym, co naprawdę ważne." },
        { title: "Miłość do siebie", desc: "Naucz się traktować siebie z troską, szacunkiem i akceptacją." },
        { title: "Harmonia", desc: "Poczuj jedność ciała, umysłu i duszy — stan, który pozostaje z tobą daleko poza matą." },
      ],
    },
    formats: {
      tag: "Formaty",
      title: "Wybierz swój format",
      intro: "Wybierz format, który pasuje do twojego rytmu życia i praktyki.",
      items: [
        { icon: "users", title: "Grupy stacjonarne", desc: "Zajęcia na żywo w przestrzeni. Praktyka w grupie, obecność, oddech i wspólne pole." },
        { icon: "monitor", title: "Grupy online", desc: "Zajęcia w czasie rzeczywistym z dowolnego miejsca." },
        { icon: "heart", title: "Indywidualnie stacjonarnie", desc: "Osobista praktyka w kontakcie na żywo." },
        { icon: "globe", title: "Indywidualnie online", desc: "Głęboka praca osobista w formacie online. Elastyczność i indywidualne wsparcie." },
        { icon: "repeat", title: "Praktyki 40-dniowe", desc: "Systematyczna praktyka dla trwałych wewnętrznych zmian. Regularność, dyscyplina i stopniowe pogłębianie stanu." },
      ],
      ctaTitle: "Chcesz dobrać format dla siebie?",
      ctaText: "Skontaktuj się ze mną — pomogę wybrać to, co pasuje właśnie tobie.",
      ctaButton: "Napisz / Zapisz się",
    },
    atmosphere: {
      tag: "Atmosfera",
      title: "Atmosfera",
      subtitle: "Przestrzeń, w której praktyka łączy się z naturą, ciszą i stanem wewnątrz.",
    },
    reviews: {
      tag: "Opinie",
      title: "Co mówią nasi uczniowie",
      items: [
        { text: "Praktyka z Aleksandrą całkowicie zmieniła moje podejście do siebie. Nauczyłam się słuchać swojego ciała i oddychać na nowo. To więcej niż joga — to droga do siebie.", name: "Maria K.", role: "Uczennica, 1 rok" },
        { text: "Po dniu pracy praktyka kundalini przywraca mi równowagę. Stres znika, pojawia się jasność i spokój. Najlepsza decyzja w moim życiu.", name: "Dmitry S.", role: "Uczeń, 8 miesięcy" },
        { text: "Atmosfera studia jest niesamowita — ciepło, troska i akceptacja. Zaczynałam od zera, a teraz nie wyobrażam sobie życia bez tych praktyk.", name: "Anna V.", role: "Uczennica, 2 lata" },
        { text: "Przyszłam z ciągłym niepokojem i bezsennością. Już po miesiącu sen się poprawił, a myśli stały się spokojniejsze. Dziękuję za delikatne podejście.", name: "Olga T.", role: "Pół roku praktyki" },
        { text: "Joga kundalini stała się moim oparciem. Praktyki oddechowe pomagają radzić sobie ze stresem w pracy w kilka minut. Polecam każdemu.", name: "Ekaterina L.", role: "Uczennica, 1,5 roku" },
        { text: "Nie wierzyłem, że joga jest dla mężczyzny bez elastyczności. Okazało się, że to o sile, oddechu i jasności umysłu. Naprawdę wciąga.", name: "Igor M.", role: "Uczeń, 4 miesiące" },
        { text: "Aleksandra to wspaniała nauczycielka. Czujesz troskę i uwagę dla każdego. Po zajęciach czujesz się jak nowo narodzony.", name: "Natalia P.", role: "Uczennica, 2 lata" },
        { text: "Praktyka 40-dniowa odmieniła to, jak widzę siebie. Pojawiła się dyscyplina, energia i prawdziwa miłość do siebie.", name: "Svetlana R.", role: "Praktyka 40-dniowa" },
        { text: "Ćwiczę online z innego miasta. Zaangażowanie i jakość są takie same jak na żywo. Bardzo wygodnie i głęboko.", name: "Andrey K.", role: "Uczeń online" },
        { text: "Każde zajęcia to mała podróż w głąb siebie. Napięcie w ciele zniknęło, pojawiła się lekkość i radość.", name: "Yulia D.", role: "Uczennica, 8 miesięcy" },
        { text: "Znalazłam tu nie tylko jogę, ale wspólnotę bliskich duchem ludzi i przestrzeń, do której chcę wracać wciąż na nowo.", name: "Victoria S.", role: "Uczennica, 3 lata" },
      ],
    },
    faq: {
      ...
      items: [
        { q: "Czym jest joga kundalini?", a: "Joga kundalini to dynamiczna praktyka łącząca ruch, oddech (pranajamę), medytację i mantry. Ma na celu obudzenie energii, wzmocnienie układu nerwowego i osiągnięcie wewnętrznej harmonii ciała, umysłu i duszy." },
        { q: "Czy nadaje się dla początkujących?", a: "Tak, jak najbardziej. Praktyka dostosowuje się do każdego poziomu. Początkujący ćwiczą we własnym, komfortowym tempie, a zaawansowani pogłębiają praktykę. Nie jest potrzebne wcześniejsze doświadczenie." },
        { q: "Co zabrać na pierwsze zajęcia?", a: "Wygodny strój z naturalnych tkanin, matę do jogi (możemy udostępnić), wodę i otwarte serce. Zalecamy, aby nie jeść obfitego posiłku na 2 godziny przed praktyką." },
        { q: "Jak wyglądają zajęcia?", a: "Zajęcia zaczynają się od nastrojenia i oddechu, następnie krija (zestaw ćwiczeń), głęboka relaksacja i medytacja. Każda praktyka to całościowa podróż trwająca około 75–90 minut." },
        { q: "Czy są zajęcia online?", a: "Tak, prowadzimy zajęcia online na żywo oraz udostępniamy nagrania. Możesz praktykować z dowolnego miejsca na świecie w dogodnym czasie." },
      ],
      closingTitle: "Jeśli masz wątpliwości — to zupełnie normalne.",
      closingText: "Możesz po prostu do mnie napisać, a pomogę ci wybrać format.",
    },
    contact: {
      tag: "Zapisy na zajęcia",
      title: "Rozpocznij swoją drogę już dziś",
      desc: "Zostaw zgłoszenie, a skontaktujemy się z tobą, aby dobrać dogodny termin pierwszych zajęć.",
      name: "Imię",
      phone: "Telefon",
      email: "Email",
      message: "Wiadomość",
      submit: "Zapisz się",
      sending: "Wysyłanie...",
      success: "Dziękujemy! Twoje zgłoszenie zostało wysłane. Wkrótce się skontaktujemy.",
      error: "Coś poszło nie tak. Spróbuj ponownie.",
    },
    footer: {
      slogan: "Find Harmony. Feel Love. Live Consciously.",
      desc: "Przestrzeń harmonii, miłości i świadomości.",
      contacts: "Kontakt",
      phone: "Telefon",
